...
func (c *CmdProtoMap) registerAllMessage() {
	...
	c.regMsg(ActivitySandbagNotice, func() any { return new(proto.ActivitySandbagNotice) })
	c.regMsg(ActivitySandbagRewardReq, func() any { return new(proto.ActivitySandbagRewardReq) })
	c.regMsg(ActivitySandbagRewardRsp, func() any { return new(proto.ActivitySandbagRewardRsp) })
	c.regMsg(ActivitySandbagHitReq, func() any { return new(proto.ActivitySandbagHitReq) })
	c.regMsg(ActivitySandbagHitRsp, func() any { return new(proto.ActivitySandbagHitRsp) })
	c.regMsg(ActivitySandbagDropNotice, func() any { return new(proto.ActivitySandbagDropNotice) })
	c.regMsg(ActivityRecallNotice, func() any { return new(proto.ActivityRecallNotice) })
	c.regMsg(ActivityRecallRewardClaimReq, func() any { return new(proto.ActivityRecallRewardClaimReq) })
	c.regMsg(ActivityRecallRewardClaimRsp, func() any { return new(proto.ActivityRecallRewardClaimRsp) })
	c.regMsg(RecallCodeUseReq, func() any { return new(proto.RecallCodeUseReq) })
	c.regMsg(RecallCodeUseRsp, func() any { return new(proto.RecallCodeUseRsp) })
	c.regMsg(ActivityUploadWishTxtReq, func() any { return new(proto.ActivityUploadWishTxtReq) })
	c.regMsg(ActivityUploadWishTxtRsp, func() any { return new(proto.ActivityUploadWishTxtRsp) })
	c.regMsg(ActivityKoiNotice, func() any { return new(proto.ActivityKoiNotice) })
	c.regMsg(ActivityKoiUseItemReq, func() any { return new(proto.ActivityKoiUseItemReq) })
	c.regMsg(ActivityKoiUseItemRsp, func() any { return new(proto.ActivityKoiUseItemRsp) })
	c.regMsg(TreasureDigReq, func() any { return new(proto.TreasureDigReq) })
	c.regMsg(TreasureDigRsp, func() any { return new(proto.TreasureDigRsp) })
	c.regMsg(TreasureIllustrationInfoReq, func() any { return new(proto.TreasureIllustrationInfoReq) })
	c.regMsg(TreasureIllustrationInfoRsp, func() any { return new(proto.TreasureIllustrationInfoRsp) })
	c.regMsg(TreasureIllustrationRewardReq, func() any { return new(proto.TreasureIllustrationRewardReq) })
	c.regMsg(TreasureIllustrationRewardRsp, func() any { return new(proto.TreasureIllustrationRewardRsp) })
	c.regMsg(GetTreasureAchieveRewardReq, func() any { return new(proto.GetTreasureAchieveRewardReq) })
	c.regMsg(GetTreasureAchieveRewardRsp, func() any { return new(proto.GetTreasureAchieveRewardRsp) })
	c.regMsg(PetCaptureReq, func() any { return new(proto.PetCaptureReq) })
	c.regMsg(PetCaptureRsp, func() any { return new(proto.PetCaptureRsp) })
	c.regMsg(PetRenameReq, func() any { return new(proto.PetRenameReq) })
	c.regMsg(PetRenameRsp, func() any { return new(proto.PetRenameRsp) })
	c.regMsg(PetDecomposeReq, func() any { return new(proto.PetDecomposeReq) })
	c.regMsg(PetDecomposeRsp, func() any { return new(proto.PetDecomposeRsp) })
	c.regMsg(PetWarehouseLimitNotice, func() any { return new(proto.PetWarehouseLimitNotice) })
	c.regMsg(GetPetReq, func() any { return new(proto.GetPetReq) })
	c.regMsg(GetPetRsp, func() any { return new(proto.GetPetRsp) })
	c.regMsg(ChangePetReq, func() any { return new(proto.ChangePetReq) })
